...
if abs(tval(id)) <= cds.options.TestTolerance & min(dist1,dist2) < 100*cds.options.VarTolerance
    break;
...
%     fprintf('testfunction behaving badly.\n');
  ...
  if abs(tval) <= cds.options.TestTolerance & min(dist1,dist2) < 100*cds.options.VarTolerance
